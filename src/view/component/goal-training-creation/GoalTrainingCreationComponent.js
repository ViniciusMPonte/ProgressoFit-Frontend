...
export class GoalTrainingCreationComponent {
    ...
    showLoading(show) {
        ...
        if (show) {
            ...
            submitBtn.innerHTML = 'Criar Objetivo'
            ...
            <form id="goal-training-creation-form">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-3">
                        <label class="g-bold" for="goal-target-value">Meta (valor alvo)</label>
                        <input 
                            type="number" 
                            step="0.1" 
                 ...
                 <div class="row mb-3">
                        <div class="col-md-6">
                            <label class="g-bold" for="goal-start-date">Data de Início</label>
                     ...
                     <div class="col-md-6">
                            <label class="g-bold" for="goal-end-date">Data de Término</label>
                            <div class="input-group custom-border">
                                <input 
                                    type="date" 
                                    id="goal-end-date" 
                 ...
                 <div class="d-flex gap-2">
                        <button type="button" class="btn btn-primary" id="goal-form-submit-btn">
                            Criar Objetivo
                        </button>
                        <button type="button" class="btn btn-light" id="goal-form-reset-btn">
                            Limpar
                        </button>
                    </div>
                </div>
...
class DOMElementManager {
    ...
    getGoalTargetValue() {
        if (!this.elements.goalTargetValue) {
            this.elements.goalTargetValue = document.querySelector('#goal-target-value')
        }
    ...
    getGoalStartDate() {
        if (!this.elements.goalStartDate) {
            this.elements.goalStartDate = document.querySelector('#goal-start-date')
        }
    ...
    getGoalEndDate() {
        if (!this.elements.goalEndDate) {
            this.elements.goalEndDate = document.querySelector('#goal-end-date')
        }
    ...
    getGoalStartCalendarBtn() {
        if (!this.elements.goalStartCalendarBtn) {
            this.elements.goalStartCalendarBtn = document.querySelector('#goal-start-calendar-btn')
        }
    ...
    getGoalEndCalendarBtn() {
        if (!this.elements.goalEndCalendarBtn) {
            this.elements.goalEndCalendarBtn = document.querySelector('#goal-end-calendar-btn')
        }
    ...
    getGoalFormSubmitBtn() {
        if (!this.elements.goalFormSubmitBtn) {
            this.elements.goalFormSubmitBtn = document.querySelector('#goal-form-submit-btn')
        }
    ...
    getGoalFormResetBtn() {
        if (!this.elements.goalFormResetBtn) {
            this.elements.goalFormResetBtn = document.querySelector('#goal-form-reset-btn')
        }
