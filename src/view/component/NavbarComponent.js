        ...
        return /*html*/`
            <nav class="navbar bg-primary fixed-top">
                <div class="container-fluid">
                    <a class="navbar-brand text-white" href="${EnvironmentConfig.BASE_URL}/"><img src="${EnvironmentConfig.BASE_URL}/src/assets/images/logotipo.svg" alt="logotipo" height="auto" width="200px"></a>
